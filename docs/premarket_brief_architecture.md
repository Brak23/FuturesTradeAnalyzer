...
**Companion docs**: `premarket_brief_design.md` (product + content), `premarket_brief_ux_design.md` (visual/UX spec, design tokens, components), `premarket_brief_build_plan.md` (step-by-step + agent assignments), `premarket_brief_vendor_research.md` (bar-data vendor decision), `premarket_brief_readiness.md` (gap register + Definition of Done).
